    ...
    accordion1 = () => {
        return (
            <View style={{ borderColor: "#36DAA5", borderWidth: 1, padding: 10 }}>
                <Text style={styles.text}>Flat:00 Building: 000, Road: 0000, Block: 000, Street Name, Area Name, District, City</Text>
            </View>
        )
    }
    accordion2 = () => {
        return (
            <View style={{ borderColor: "#36DAA5", borderWidth: 1, padding: 10 }}>
              ...
              <Icon name='ios-add-circle-outline' style={styles.icon} />
                ...
                <View style={{flexDirection:"row-reverse", marginTop: 5,borderBottomWidth:1,borderBottomColor: "#999",paddingBottom:5}}>
                    <View style={{width:"30%"}}>
                ...
                <View style={{flexDirection:"row", marginTop: 5,}}>
                    <Text style={styles.textsm}> Estimated Complete on Time: 00:00 hours</Text>
                </View>
                <View style={{ flexDirection: "row", justifyContent: "space-between", padding: 10, marginTop: 10 }}>
                    ...
                    <View>
                        ...
                        >
                            <TouchableOpacity>
                                <Text style={{ color: "#FFF", marginLeft: 20, marginRight: 20 }}>Submit</Text>
                            </TouchableOpacity>
                        </LinearGradient>
            ...
            <ScrollView>
                <Row style={{ marginTop: 20 }}>
                    <View style={{ flex: 1, justifyContent: 'center', flexDirection: 'row' }}>
                        <Text style={{ color: "#23759E", fontSize: 20, }}>Service Estimation</Text>
                    </View>
                </Row>
...
const styles = StyleSheet.create({
    ...
    textcolor: {
        color: "#1CB9A3", fontSize: 18, marginLeft: 10,
        marginRight: 10
    },
    icon: {
        color: "#1CB9A3", fontSize: 25
    },
    aBorderText: {
        flexDirection: 'row',
        justifyContent: "space-between",
