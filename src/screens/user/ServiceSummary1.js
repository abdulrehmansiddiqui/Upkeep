...
export default class ServiceSummary1 extends Component {
            ...
            <Container>
                <Content>
                    ...
                    <View style={{ flexDirection:"row",justifyContent:"space-around",marginTop: 20  }}>
                        <View style={{backgroundColor:"#ccc", padding:10,borderRadius:8}}>
                            <Text style={{
                                color: "#000", fontWeight: '300', fontSize: 15,marginLeft:20,marginRight:20}}>
                                Cancell
                                </Text>
                        </View>
                        ...
                        >
                            <Text style={{
                                color: "#fff", fontWeight: '300', fontSize: 15,marginLeft:20,marginRight:20
                            }}
                            >
                                Play Now
                                </Text>
