  ...
  render() {
    return (
      <View style={styles.container}>
        ...
        <Text style={{ color: "#127366", fontSize: 15 }}>
        ...
        <View style={{ alignItems: "center" }}>
          ...
          <TextInput style={styles.input} placeholder={this.state.fullName} />
          <TextInput style={styles.input} placeholder={this.state.mobile} />
          ...
          <TouchableOpacity>
            <View style={{ marginTop: 10, width: 140, alignItems: "center" }}>
              <Image
                ...
                style={{ height: 80, width: 170, borderRadius: 5 }}
              />
            </View>
          </TouchableOpacity>
        </View>
